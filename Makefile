...
docs-reference-check: docs-reference  ## Fail if the generated reference pages are stale
	...
	@out="$$(git status --porcelain -- docs/reference/apps.md docs/reference/admission-policies.md docs/reference/flux-kustomizations.md docs/reference/helm-releases.md docs/reference/ingress.md docs/explanation/app-backups.md)"; \
	if [ -n "$$out" ]; then \
		echo "$$out"; \
		echo; \
