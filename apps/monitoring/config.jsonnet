...

{
  ...
  grafana+: {
    ...
    env: [
      ...
      // { name: 'GF_AUTH_SIGNOUT_REDIRECT_URL', value: 'https://auth.ankhmorpork.thaum.xyz/_oauth2/logout' }, // TODO: Uncomment after switiching Ingress traffic
      { name: 'GF_AUTH_BASIC_ENABLED', value: 'false' },
      { name: 'GF_AUTH_PROXY_AUTO_SIGN_UP', value: 'false' },
      { name: 'GF_AUTH_PROXY_ENABLED', value: 'true' },
      // { name: 'GF_AUTH_PROXY_HEADER_NAME', value: 'X-Forwarded-User' },   // TODO: Uncomment after switiching Ingress traffic
      { name: 'GF_AUTH_PROXY_HEADER_NAME', value: 'X-Auth-Request-Email' },
      { name: 'GF_AUTH_PROXY_HEADER_PROPERTY', value: 'username' },
      // { name: 'GF_AUTH_PROXY_HEADERS', value: 'Email:X-Forwarded-User' },   // TODO: Uncomment after switiching Ingress traffic
