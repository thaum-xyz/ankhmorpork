...

{
  ...
  grafana+: {
    version: '11.3.0',  // application-version-from-github: grafana/grafana
    image: 'grafana/grafana:11.3.0',  // application-image-from-github: grafana/grafana
    datasources: [{
      name: 'Prometheus',
      type: 'prometheus',
      access: 'proxy',
    ...
    env: [
      ...
      { name: 'GF_AUTH_SIGNOUT_REDIRECT_URL', value: 'https://auth.ankhmorpork.thaum.xyz/_oauth2/logout' },
